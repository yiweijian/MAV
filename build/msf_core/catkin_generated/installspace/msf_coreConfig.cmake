...
if(NOT "include;/usr/local/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'msf_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/install/${idir}'.  Ask the maintainer 'Simon Lynen <simon.lynen@mavt.ethz.ch>, Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
    endif()

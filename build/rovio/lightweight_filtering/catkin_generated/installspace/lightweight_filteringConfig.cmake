...
if(NOT "include;/usr/local/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lightweight_filtering' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/install/${idir}'.  Ask the maintainer 'Michael Bloesch <bloeschm@ethz.ch>' to fix it.")
    endif()

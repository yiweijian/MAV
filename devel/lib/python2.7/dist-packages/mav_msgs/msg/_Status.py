...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3f.pack(_x.command_interface_enabled, _x.flight_time, _x.system_uptime, _x.cpu_load))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.in_air))
      _x = self.gps_status
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.gps_num_satellites))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.command_interface_enabled, _x.flight_time, _x.system_uptime, _x.cpu_load,) = _struct_B3f.unpack(str[start:end])
      ...
      (self.in_air,) = _struct_B.unpack(str[start:end])
      ...
      (self.gps_num_satellites,) = _struct_i.unpack(str[start:end])
      return self

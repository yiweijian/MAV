...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.torque.x, _x.torque.y, _x.torque.z, _x.thrust.x, _x.thrust.y, _x.thrust.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.torque.x, _x.torque.y, _x.torque.z, _x.thrust.x, _x.thrust.y, _x.thrust.z,) = _struct_6d.unpack(str[start:end])
      return self

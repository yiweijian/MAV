...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.latitude, _x.longitude, _x.altitude, _x.heading, _x.maxSpeed, _x.maxAcc))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.latitude, _x.longitude, _x.altitude, _x.heading, _x.maxSpeed, _x.maxAcc,) = _struct_6d.unpack(str[start:end])
      return self

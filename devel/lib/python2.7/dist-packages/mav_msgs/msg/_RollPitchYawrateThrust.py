...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6d.pack(_x.roll, _x.pitch, _x.yaw_rate, _x.thrust.x, _x.thrust.y, _x.thrust.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.roll, _x.pitch, _x.yaw_rate, _x.thrust.x, _x.thrust.y, _x.thrust.z,) = _struct_6d.unpack(str[start:end])
      return self

...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_id.pack(_x.int_param, _x.double_param))
      _x = self.str_param
      length = len(_x)
      ...
      _x = self
      buff.write(_struct_Bi.pack(_x.bool_param, _x.enum_param))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.int_param, _x.double_param,) = _struct_id.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.bool_param, _x.enum_param,) = _struct_Bi.unpack(str[start:end])

...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3i.pack(_x.num_coeffs, _x.segment_time.secs, _x.segment_time.nsecs))
      length = len(self.x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num_coeffs, _x.segment_time.secs, _x.segment_time.nsecs,) = _struct_3i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length

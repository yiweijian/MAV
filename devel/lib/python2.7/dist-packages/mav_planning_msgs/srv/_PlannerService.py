...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3I.pack(_x.success, _x.polynomial_plan.header.seq, _x.polynomial_plan.header.stamp.secs, _x.polynomial_plan.header.stamp.nsecs))
      ...
      for val1 in self.polynomial_plan.segments:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_i.pack(val1.num_coeffs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.sampled_plan.header.seq, _x.sampled_plan.header.stamp.secs, _x.sampled_plan.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.polynomial_plan.header.seq, _x.polynomial_plan.header.stamp.secs, _x.polynomial_plan.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (val1.num_coeffs,) = _struct_i.unpack(str[start:end])
      ...
      (_x.sampled_plan.header.seq, _x.sampled_plan.header.stamp.secs, _x.sampled_plan.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end

...
struct GetParamsRequest_
{
  ...
  _key_type key;
    ...
    enum { IMG_INTRINSICS = 0u };
     enum { IMG_EXTRINSICS_RTOL = 1u };
     enum { IMU_INTRINSICS = 2u };
     enum { IMU_EXTRINSICS = 3u };
...
// {'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg'], 'mynteye_wrapper_d': ['/home/nuc/wangl/vins_catkin_ws/src/mynteye/src/mynteye_wrapper_d/msg']}

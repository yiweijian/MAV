...
if("TRUE" STREQUAL "TRUE")
  set(msf_distort_SOURCE_PREFIX /home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_distort)
  set(msf_distort_DEVEL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/devel)
  ...
  set(msf_distort_INSTALL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/install)
...
if(NOT "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_timing/include;/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core/include;/opt/ros/indigo/include;/usr/local/include/eigen3;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(msf_distort_INCLUDE_DIRS "")
  set(_include_dirs "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_timing/include;/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core/include;/opt/ros/indigo/include;/usr/local/include/eigen3;/usr/include;/usr/include/opencv")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'msf_distort' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Simon Lynen <simon.lynen@mavt.ethz.ch>, Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'msf_distort' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_distort/${idir}'.  Ask the maintainer 'Simon Lynen <simon.lynen@mavt.ethz.ch>, Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${msf_distort_dep}_FOUND)
      find_package(${msf_distort_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${msf_distort_dep} REQUIRED ${depend_list})
  endif()

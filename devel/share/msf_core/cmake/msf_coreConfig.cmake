...
if("TRUE" STREQUAL "TRUE")
  set(msf_core_SOURCE_PREFIX /home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core)
  set(msf_core_DEVEL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/devel)
  set(msf_core_INSTALL_PREFIX "")
  set(msf_core_PREFIX ${msf_core_DEVEL_PREFIX})
else()
  set(msf_core_SOURCE_PREFIX "")
  set(msf_core_DEVEL_PREFIX "")
  set(msf_core_INSTALL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/install)
...
if(NOT "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(msf_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core/include;/usr/local/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'msf_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Simon Lynen <simon.lynen@mavt.ethz.ch>, Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'msf_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core/${idir}'.  Ask the maintainer 'Simon Lynen <simon.lynen@mavt.ethz.ch>, Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${msf_core_dep}_FOUND)
      find_package(${msf_core_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${msf_core_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "/home/nuc/yi/vins/vins_catkin_ws/src/ethzasl_msf/msf_core/cmake/export_flags.cmake")

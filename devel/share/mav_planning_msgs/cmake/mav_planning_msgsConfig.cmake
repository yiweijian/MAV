...
if("TRUE" STREQUAL "TRUE")
  set(mav_planning_msgs_SOURCE_PREFIX /home/nuc/yi/vins/vins_catkin_ws/src/mav_comm/mav_planning_msgs)
  set(mav_planning_msgs_DEVEL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/devel)
  ...
  set(mav_planning_msgs_INSTALL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/install)
...
if(NOT "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/mav_comm/mav_planning_msgs/include;/usr/local/include/eigen3 " STREQUAL " ")
  set(mav_planning_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/mav_comm/mav_planning_msgs/include;/usr/local/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mav_planning_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Helen Oleynikova <helen.oleynikova@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mav_planning_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/src/mav_comm/mav_planning_msgs/${idir}'.  Ask the maintainer 'Helen Oleynikova <helen.oleynikova@mavt.ethz.ch>' to fix it.")
    endif()
...
set(mav_planning_msgs_EXPORTED_TARGETS "mav_planning_msgs_generate_messages_cpp;mav_planning_msgs_generate_messages_lisp;mav_planning_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mav_planning_msgs_dep}_FOUND)
      find_package(${mav_planning_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mav_planning_msgs_dep} REQUIRED ${depend_list})
  endif()

...
if("TRUE" STREQUAL "TRUE")
  set(mav_nonlinear_mpc_SOURCE_PREFIX /home/nuc/yi/vins/vins_catkin_ws/src/mav_control_rw/mav_nonlinear_mpc)
  set(mav_nonlinear_mpc_DEVEL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/devel)
  ...
  set(mav_nonlinear_mpc_INSTALL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/install)
...
if(NOT "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/include " STREQUAL " ")
  set(mav_nonlinear_mpc_INCLUDE_DIRS "")
  set(_include_dirs "/home/nuc/yi/vins/vins_catkin_ws/devel/include;/home/nuc/yi/vins/vins_catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mav_nonlinear_mpc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Mina Kamel <mina.kamel@mavt.ethz.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mav_nonlinear_mpc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/${idir}'.  Ask the maintainer 'Mina Kamel <mina.kamel@mavt.ethz.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mav_nonlinear_mpc_dep}_FOUND)
      find_package(${mav_nonlinear_mpc_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mav_nonlinear_mpc_dep} REQUIRED ${depend_list})
  endif()

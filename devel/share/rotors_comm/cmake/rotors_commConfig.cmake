...
if("TRUE" STREQUAL "TRUE")
  set(rotors_comm_SOURCE_PREFIX /home/nuc/yi/vins/vins_catkin_ws/src/rotors_simulator/rotors_comm)
  set(rotors_comm_DEVEL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/devel)
  ...
  set(rotors_comm_INSTALL_PREFIX /home/nuc/yi/vins/vins_catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>, Mina Kamel <mina.kamel@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/yi/vins/vins_catkin_ws/src/rotors_simulator/rotors_comm/${idir}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>, Mina Kamel <mina.kamel@mavt.ethz.ch>' to fix it.")
    endif()
